...
Question banking_q1 = Question(
  ...
  questionDescription:
      "סיווג חשבון לפי סטטוס מאפשר לכם להנות מהטבות ותנאים מותאמים לסטטוס. לעיתים זה עשוי להיות משמעותי מבחינת עמלות והטבות. יש לוודא שסיווג החשבון תואם את סטטוס החיים ויש לעדכנו מדי פעם. ",
  categories: ["bank"],
  sortScore: 10,
  filters: [],
  answers: [
